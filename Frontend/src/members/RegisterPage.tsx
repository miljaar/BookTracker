...
export function RegisterPage() {
    ...
    const badRequest = registerMutation.error instanceof ApiError && registerMutation.error.status === 400;
    const duplicateEmail = registerMutation.error instanceof ApiError && registerMutation.error.status === 409;
