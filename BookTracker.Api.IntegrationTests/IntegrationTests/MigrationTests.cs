...
namespace BookTracker.Api.IntegrationTests.Migrations;

[Collection(PostgreSqlCollection.Name)]
public class MigrationTests(PostgreSqlFixture database) : IntegrationTest(database)
{

    [Fact]
    public void MigrationCreateUsablePostgreSqlDatabase()
    {
